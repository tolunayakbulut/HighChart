  ...
  routes: [
    ...
    // =============================================================================
      ...
      children: [
        ...
        {
          path: '/charts-and-maps/charts/highcharts',
          name: 'extra-component-charts-highcharts',
          component: () => import('@/views/charts-and-maps/charts/highcharts/HighCharts.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Charts & Maps' },
              { title: 'highcharts', active: true }
            ],
            pageTitle: 'highcharts',
            rule: 'editor'
          }
        },
        {
